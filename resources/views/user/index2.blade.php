                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            <input type="hidden" id="url" value="{{url('user/fadd')}}?t=2">
                          
                           
                            {{csrf_field()}}
                            
                           
                            <button class="layui-btn" id="adds" type="button"><i class="layui-icon"></i>添加床位</button>
                        ...
                        <div class="layui-card-body ">
                             <form action="">
            <input type="text" name="n" class="layui-input" style="width:200px;display:inline">
                            ...
                            <table class="layui-table layui-form">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="td-manage">
                                    <input type="hidden" id="ed{{$v->id}}" value="{{url('user/fedit')}}/{{$v->id}}">
                                    <input type="hidden" id="de{{$v->id}}" value="{{url('user/fdelete')}}/{{$v->id}}">
                                    <script type="text/javascript">
                                    ...
                                    <a title="删除"  href="{{url('user/fdelete')}}/{{$v->id}}">
                                      <i class="layui-icon">&#xe640;</i>
                                    </a>
                                  </td>
                                </tr>
