                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <button class="layui-btn" id="adds" type="button"><i class="layui-icon"></i>添加人员</button>
                            ...
                            <table class="layui-table layui-form">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="td-manage">
                                    <input type="hidden" id="ed{{$v->id}}" value="{{url('user/uuedit')}}/{{$v->id}}">
                                    <input type="hidden" id="de{{$v->id}}" value="{{url('user/uudelete')}}/{{$v->id}}">
                                    <script type="text/javascript">
