...
<html class="x-admin-sm">
    ...
    <body>       
        ...
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="{{url('user/fnew')}}" method="post" enctype="multipart/form-data">
                  <div class="layui-form-item">
                      <label for="username" class="layui-form-label">
                          <span class="x-red">*</span>床位名
                      </label>
                      {{csrf_field()}}
                 ...
                 <input type="hidden" name="t" value="{{$t}}">
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                         <textarea  name="content" style="width: 400px;height: 100px"  class="layui-input"></textarea> 
                      </div>
                      <div class="layui-form-mid layui-word-aux">
