                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            <input type="hidden" id="url" value="{{url('user/uadd')}}?t=3">
                        ...
                        <div class="layui-card-body " style="width:1200px;overflow-x:scroll">
                            <table class="layui-table layui-form">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="td-manage">
                                    <input type="hidden" id="ed" value="{{url('user/uuedit')}}/{{$v->id}}">
                                    <input type="hidden" id="de" value="{{url('user/uudelete')}}/{{$v->id}}">
                                    <script type="text/javascript">
                                      var ed=$('#ed').val();
                                      var de=$('#de').val();
                                    </script>
                                    <a title="编辑"  onclick="xadmin.open('编辑',ed)" href="javascript:;">
                                      <i class="layui-icon">&#xe642;</i>
                                    </a>
                                    <a title="删除"  href="{{url('user/udelete')}}/{{$v->id}}">
                                      <i class="layui-icon">&#xe640;</i>
                                    </a>
                                  </td>
                                </tr>
