                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            <input type="hidden" id="url" value="{{url('user/dadd')}}?t=3">
                          
                           
                            {{csrf_field()}}
                            
                           
                            <button class="layui-btn" id="adds" type="button"><i class="layui-icon"></i>添加订单</button>
                            ...
                            <table class="layui-table layui-form">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="td-manage">
                                    <input type="hidden" id="ed{{$v->id}}" value="{{url('user/dedit')}}/{{$v->id}}">
                                    <input type="hidden" id="de{{$v->id}}" value="{{url('user/ddelete')}}/{{$v->id}}">
                                    <script type="text/javascript">
                                    ...
                                    <a title="删除"  href="{{url('user/ddelete')}}/{{$v->id}}">
                                      <i class="layui-icon">&#xe640;</i>
                                    </a>
                                  </td>
                                </tr>
